...
#---------------------------------------------------------------------------------
for year in years: 
    R01data= pd.read_csv('/datascience/nihProject/rawData/K99dataGender%d.csv'%year,low_memory=False)
...
#fitted line for number of grants/gender
...
#difference between genders in num of grants
diffNumGrants=np.divide(fittedLineNumM,fittedLineNumF)

#difference in number of faculty
diffFaculty=np.divide(fittedLineFacultyM,fittedLineFacultyF)

paramsRatio=doLinearReg(diffFaculty,diffNumGrants)
